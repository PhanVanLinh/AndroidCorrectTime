package toong.vn.androidcorrecttime.api;
...
public class SharedPreferenceApi {
    ...
    public static final String PREFS_DELTA_TIME = "PREFS_DELTA_TIME";
    public static final String PREFS_DELTA_TIME_FROM_REBOOT = "PREFS_DELTA_TIME_FROM_REBOOT";
